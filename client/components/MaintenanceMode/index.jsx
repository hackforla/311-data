  ...
  <div className="maintenance" role="banner">
    <div className="maintenance-overlay-text">
      ...
      <div className="maintenance-text">
        <div>
          <span>Hack for LA's 311 data analysis is down temporarily while we rebuild.
          If you are looking to place a 311 ticket, please visit Los Angeles's 311 system: </span>
